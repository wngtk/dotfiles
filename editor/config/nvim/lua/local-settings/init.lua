...
vim.api.nvim_create_autocmd('FileType', {
    ...
    callback = function()
        vim.cmd('iabbrev <expr> dst strftime("%a %b %d %Y") .. " Wang Tiaoke <wangtiaoke@cqsoftware.com.cn> - " .. v:lua.get_spec_info()')
        vim.cmd('iabbrev <expr> vst v:lua.get_spec_info(v:lua.upstream_spec_path())')
    end,
})